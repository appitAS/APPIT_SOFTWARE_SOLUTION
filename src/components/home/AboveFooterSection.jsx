...
const AboveFooterSection = ({socialMediaLink=true}) => {
  ...
  return (
    ...
    >
      {/* Main Container */}
      <div className="max-w-[1440px] mx-auto flex flex-col items-start w-full px-0 sm:px-4 md:px-[60px] lg:px-[120px]">
        ...
        {socialMediaLink && (
          <div className="w-full">
            ...
            <div className="flex flex-wrap justify-start sm:justify-between items-center w-full gap-4 sm:gap-5 mb-8 sm:mb-12 md:mb-16">
              {/* Facebook Container */}
              <a
                href="https://www.facebook.com/Appitsoftwaresolutionspvtltd"
                target="_blank"
              ...
              {/* Instagram Container */}
              <a
                href="https://www.instagram.com/appitsoftware/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 sm:gap-4"
              ...
              {/* LinkedIn Container */}
              <a
                href="https://www.linkedin.com/company/appitsoftware/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 sm:gap-4"
                aria-label="LinkedIn"
        ...
        <div className={`w-full mb-6 sm:mb-8 md:mb-10 ${socialMediaLink ? '' : 'mt-10'}`}>
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 xs:gap-6 sm:gap-8 md:gap-12 w-full px-0 sm:px-4 md:px-[60px] lg:px-[120px] mb-4">
            ...
            <div className="flex">
              ...
              <div className="flex flex-col pl-3 sm:pl-4">                <div className="py-2 sm:py-2.5">
                  <Link href="/services/services-now-ai" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                ...
                </div>                <div className="py-2 sm:py-2.5">
                  <Link href="/services/oracle-ai" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                    <div className="relative pl-0 group-hover:pl-5 sm:group-hover:pl-7 transition-all duration-300 ease-out">
                      <svg className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{top: '2px'}} width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.5L8 8L0.5 14.5" stroke="#FF5555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                  ...
                  <Link href="/services/generative-ai" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                    <div className="relative pl-0 group-hover:pl-5 sm:group-hover:pl-7 transition-all duration-300 ease-out">
                      <svg className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{top: '2px'}} width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.5L8 8L0.5 14.5" stroke="#FF5555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      <span className="relative z-10">Generative AI Solutions</span>
                    </div>
                  </Link>
                </div>
              </div>
            ...
            <div className="flex">
              ...
              <div className="flex flex-col pl-3 sm:pl-4">                <div className="py-2 sm:py-2.5">
                  ...
                  <Link href="/services/manage-services" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                    <div className="relative pl-0 group-hover:pl-5 sm:group-hover:pl-7 transition-all duration-300 ease-out">
                      <svg className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{top: '2px'}} width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.5L8 8L0.5 14.5" stroke="#FF5555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                  ...
                  <Link href="/services/digital-transformation-services" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                    <div className="relative pl-0 group-hover:pl-5 sm:group-hover:pl-7 transition-all duration-300 ease-out">
                      <svg className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{top: '2px'}} width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.5L8 8L0.5 14.5" stroke="#FF5555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
            ...
            <div className="flex">
              <div className="w-1 h-[129px] bg-[#0066B3]"></div>
              <div className="flex flex-col pl-3 sm:pl-4">                <div className="py-2 sm:py-2.5">
                  <Link href="/services/ecommerce-services" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                    <div className="relative pl-0 group-hover:pl-5 sm:group-hover:pl-7 transition-all duration-300 ease-out">
                      <svg className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{top: '2px'}} width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.5L8 8L0.5 14.5" stroke="#FF5555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                  ...
                  <Link href="/services/magento-open-source" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                    <div className="relative pl-0 group-hover:pl-5 sm:group-hover:pl-7 transition-all duration-300 ease-out">
                      <svg className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{top: '2px'}} width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.5L8 8L0.5 14.5" stroke="#FF5555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      <span className="relative z-10">Magento Open Source</span>
                    </div>
                  </Link>
                </div>                <div className="py-2 sm:py-2.5">
                  <Link href="/services/cybersecurity" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                    <div className="relative pl-0 group-hover:pl-5 sm:group-hover:pl-7 transition-all duration-300 ease-out">
                      <svg className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{top: '2px'}} width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.5L8 8L0.5 14.5" stroke="#FF5555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      <span className="relative z-10">Cybersecurity Solutions</span>
                    </div>
                  </Link>
                </div>
              </div>
            ...
            <div className="flex">
              <div className="w-1 h-[129px] bg-[#0066B3]"></div>
              <div className="flex flex-col pl-3 sm:pl-4">                <div className="py-2 sm:py-2.5">
                  <Link href="/contact" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                    <div className="relative pl-0 group-hover:pl-5 sm:group-hover:pl-7 transition-all duration-300 ease-out">
                      <svg className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{top: '2px'}} width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.5L8 8L0.5 14.5" stroke="#FF5555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                  ...
                  <Link href="/career" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                    <div className="relative pl-0 group-hover:pl-5 sm:group-hover:pl-7 transition-all duration-300 ease-out">
                      <svg className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{top: '2px'}} width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.5L8 8L0.5 14.5" stroke="#FF5555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                  ...
                  <Link href="/about" className="group inline-block text-[#252525] hover:text-[#FF5555] font-jost text-sm sm:text-base font-bold leading-[120%] transition-all duration-300">
                    <div className="relative pl-0 group-hover:pl-5 sm:group-hover:pl-7 transition-all duration-300 ease-out">
                      <svg className="absolute left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{top: '2px'}} width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.5L8 8L0.5 14.5" stroke="#FF5555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
