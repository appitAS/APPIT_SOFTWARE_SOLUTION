...
export default function WhatWeDoDropdown({
 ...
 const serviceItems = [
  ...
  if (isMobile) {
    ...
    return (
      <div
        className={`mt-2 transition-all duration-200 ease-out ${getAnimationClasses()}`}
      >
