...
const AllInOneCRMHero = () => {
  return (
    <Section
      videoSrc="/videos/all-in-one-crm.mp4"
          ...
          <HeadingPara
            title={
              <>
                ...
                <span className="text-red-500">Every Customer.</span> Every
                Team. One Powerful{" "}
                <span className="text-red-500">Platform.</span>
              </>
            }
            para="All-in-One CRM Solution – Manage Leads, Sales, Support, and Marketing – all from a single dashboard"
...
export default AllInOneCRMHero;
