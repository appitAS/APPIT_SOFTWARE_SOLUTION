...
export default function AITalentAcquisition() {
  ...
  return (
    <header data-custom="ai-talent-acquisition" className={`fixed w-full top-0 z-50 transition-all duration-150 ${scrolled ? 'bg-white shadow-sm' : 'bg-transparent'} font-jost`}>
        ...
        <div className="w-full max-w-[1440px] px-4 sm:px-[30px] md:px-[60px] py-[16px] flex justify-between items-center">
          ...
          <nav className={`hidden 2xl:flex lg:flex xl:flex custom940:flex items-center gap-[20px] lg:gap-[35px] flex-wrap justify-center mx-auto ${isInitialRender ? 'no-transition' : ''}`}>
            <div className="relative py-[10px] px-[8px] flex justify-center items-center" ref={whoWeAreRef}>
              <button 
                className={`text-[17px] lg:text-[21px] font-bold leading-[120%] font-jost flex items-center whitespace-nowrap transition-colors duration-300 hover:text-[#C7131A] text-[#000]`}
            ...
            <Link href="/career" className={`py-[10px] px-[8px] text-[17px] lg:text-[21px] font-bold leading-[120%] font-jost transition-colors duration-300 hover:text-[#C7131A] flex justify-center items-center text-[#000]`}>
              Career
            </Link>
            <Link href="/contact" className={`py-[10px] px-[8px] text-[17px] lg:text-[21px] font-bold leading-[120%] font-jost transition-colors duration-300 hover:text-[#C7131A] flex justify-center items-center text-[#000]`}>
              Contact
            </Link>
          </nav>
