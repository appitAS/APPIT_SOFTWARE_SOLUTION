...
export default function HelixAIPharmaHeader() {
  ...
  return (
    <header data-custom="ai-lawyer" className={`fixed w-full top-0 z-50 transition-all duration-150 ${scrolled ? 'bg-white shadow-sm' : 'bg-transparent'} font-jost`}>
