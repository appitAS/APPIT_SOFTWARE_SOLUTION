  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        // Add form data manually to ensure correct values
        ...
        // Add additional fields formsubmit.co expects
        submitFormData.append('_subject', 'Job Application: Jr UI UX Designer Intern');
        submitFormData.append('_template', 'table');
        submitFormData.append('_captcha', 'false');
        
        // Prevent redirect by adding these fields
        submitFormData.append('_next', '#');
        submitFormData.append('_redirect', 'false');
        
        // Submit via fetch - using ajax endpoint
        const formSubmitUrl = `https://formsubmit.co/ajax/${encodeURIComponent(RECIPIENT_EMAIL)}`;
        ...
        // FormSubmit.co might return success as string or boolean
        ...
        // Log error for debugging but don't show details to user
      ...
      <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row items-start justify-center gap-8 sm:gap-10 md:gap-12 lg:gap-20 xl:gap-24 lg:pl-8 xl:pl-12">
        ...
        >
            ...
            <div className="w-full flex flex-row justify-between items-start gap-6">
              <div className="flex flex-col items-start gap-2.5 w-[calc(100%-70px)] sm:w-[calc(100%-80px)] md:w-[calc(100%-90px)]">
                ...
                <div className="flex flex-col items-start gap-2.5">
                  <h3 className="text-lg sm:text-xl md:text-[21px] font-semibold leading-[120%] text-black">Jr UI UX Designer Intern</h3>
                  <p className="text-base md:text-[16px] font-semibold leading-[120%] text-[#252525]">Designer</p>
                </div>
                ...
                <div className="flex flex-col xs:flex-row items-start xs:items-center gap-3 xs:gap-6 mt-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm sm:text-base font-normal leading-[120%] text-[#454545] break-words">Hybrid - Hyderabad, India</span>
                  </div>
                </div>
              </div>
          ...
          <div className="w-full flex flex-col gap-6 md:gap-8">
            <h3 className="text-lg sm:text-xl md:text-[21px] font-semibold leading-[120%] text-black">💼 Join APPIT Software as a UI/UX Designer</h3>
            
            <p className="text-sm sm:text-base font-normal leading-[140%] md:leading-[160%] text-black">
              APPIT Software is seeking a talented and creative UI/UX Designer to join our growing team. This is an exciting opportunity to shape user experiences for innovative digital solutions while working in a collaborative and forward-thinking environment.
            </p>
